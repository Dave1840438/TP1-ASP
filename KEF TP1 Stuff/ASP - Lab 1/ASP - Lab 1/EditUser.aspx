<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditUser.aspx.cs" Inherits="ASP___Lab_1.EditUsers" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        {
            document.getElementById("IMG_Avatar").src = src;
            PreLoadImage();
        }
        ...
        function BuildForm(targetFormID) {
            ...
            document.getElementById(targetFormID).appendChild(BuildTable(12, 3));
